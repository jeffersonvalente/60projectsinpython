...
score_msg = score_font.render("Pontuação : ", 1, pygame.Color("green"))
score_msg_size = score_font.size("Pontuação")
background_color = pygame.Color(69,139,116) #fundo
...
class Apple:
    def __init__(self, x ,y,state):
        ...
        self.y = y
        self.state = state
        self.color = pygame.color.Color("orange")     # da comida
...
class snake:
    ...
    def getHead(self):    # cabeça da cobra
        return(self.stack[0]) 
    ...
    # desenha a cobra 
    def draw(self,screen):
        pygame.draw.rect(screen,pygame.color.Color("black"), (self.stack[0].x , self.stack[0].y, 
...
def endGame():
    ...
    message_play_again = play_again_font.render("Jogar outra vez ? (Y/N)",1,pygame.Color("green"))
...
def drawGameTime(gameTime):
    game_time = score_font.render("Tempo : " , 1, pygame.Color("white"))
...
def main():
    ...
    mySnake.move()
    start_segments = 3   # tamanho inicial da cobra
    ...
    # food
    max_apples = 1  # adiciona 1 quando come
    eaten_apple = False   # se comer a maça, ela desaparece
